...
import '@polymer/paper-autocomplete/paper-autocomplete.js'
import '@polymer/paper-autocomplete-chips/paper-autocomplete-chips.js'
  ...
  <script>
    ...
    class ModelSearch extends Polymer.Element {
      ...
      ready() {
        ...
        var dropdownContent = Polymer.dom(this.root).querySelector('paper-dropdown-menu');
        ...
        dropdownContent.addEventListener('selected-item-changed', function(event){
          ...
          var inp = Polymer.dom(_self.root).querySelector('#category')
