              ...
              <div class="body">
                ...
                <div>
                  <template is="dom-if" if="{{_checkArray(item.input)}}">
                    <h4>These are the Input Files Used by this configuration.Click to know the variables used by the files :</h4>
                    <template is="dom-repeat" items="{{item.input}}" as="stuff">
                      <a href="[[routePath]]variable-presentation"><vaadin-button class="pointer" variable\$="{{stuff.io.value}}" label\$="{{stuff.iolabel.value}}" desc\$="{{stuff.ioDescription.value}}" on-click="openConfigForUri" raised="">{{stuff.iolabel.value}}</vaadin-button></a>
                ...
                <div>
                  <template is="dom-if" if="[[_checkArray(item.output)]]">
                    <h4>These are the Output Files generated by this configuration. Click to know the variables used by the files :</h4>
                ...
                <div>
                  <template is="dom-if" if="[[_checkArray(item.cags.value)]]">
                    <h4>These are the Causual Analysis Graphs of the model. Click to know the proceeses being modeled :</h4>
