                ...
                <div>
                  <template is="dom-if" if="{{_checkArray(item.input)}}">
                    ...
                    <template is="dom-repeat" items="{{item.input}}" as="stuff">
                      <a href="[[routePath]]variable-presentation"><vaadin-button class="pointer" variable\$="{{stuff.io.value}}" on-click="openConfigForUri" raised="">{{stuff.iolabel.value}}</vaadin-button></a>
...
`;
  ...
  openConfigForUri(e) {
      ...
      var _parent = document.querySelector("mint-explorer-app");
      _parent.variableSelected=configuration;
