...
class MyAbout extends PolymerElement {
  static get template() {
    ...
    <center><h1>What is MINT?<paper-chip label="v 0.0.4" class="custom-background-m" id="btn"></paper-chip><paper-tooltip class="giant" for="btn">This release consists of the following features:<br><ul><li>New search UI with clear button to clear seach bar and category</li><br><li>New UI for displaying models</li><br><li>Additional Metadata including Category, image of models.</li><br><li>Use vaadin tabs to store more data and display one tab at a time</li></ul></paper-tooltip></h1></center>
    <center>
